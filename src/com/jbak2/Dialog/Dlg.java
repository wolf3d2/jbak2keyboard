 ...
 * @param call Обработчик, вызываемый при нажатии кнопки в диалоге. Первый параметр - код нажатой кнопки в виде Integer*/       
    ...
    public static AlertDialog customDialog(Context c,View customView,String but1,
    		String but2,String but3,UniObserver obs)
    {
    ...
    /** кастомный диалог.
     * Если кнопка = null, то она не отображается
     */
    public static AlertDialog customDialog(Context c, int layout, 
...
//        alert.setContentView(view);
    ...
    public static AlertDialog showImageWindow(Context c,View customView,String but1,
    		String but2,String but3,UniObserver obs)
    {
        AlertDialog.Builder bd = new AlertDialog.Builder(c);
        dlg = bd.create();
...
/** */      
                ...
                return new UniObserver()
                {
                    ...
                    public int OnObserver(Object param1, Object param2)
                    {
                        if (ServiceJbKbd.inst!=null
                        		&&ServiceJbKbd.inst.isInputViewShown()
 ...
 /** нажатие какой кнопки диалога возвращаем, если окно закрывается по кнопке Назад 
  * в диалоге должны быть:
  * return_button = AlertDialog.название_кнопки_возврата, и
